...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #18181c 0%, #0a0a0b 100%);
      box-shadow: 
  ...
  .card-sheen {
      ...
      background: radial-gradient(800px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(250, 240, 220, 0.05) 0%, transparent 40%);
  ...
  .btn-modern-light {
      background: linear-gradient(180deg, #c8f135 0%, #a8d420 100%);
      color: #0a0a0b;
  ...
  .btn-modern-light:active {
      ...
      background: linear-gradient(180deg, #a8d420 0%, #90b818 100%);
...
export function CinematicHero({ 
  brandName = "FundRadar",
  tagline1 = "Stop searching.",
  tagline2 = "Start building.",
  cardHeading = "Capital, unified.",
  cardDescription = <><span className="text-[#c8f135] font-semibold">FundRadar</span> automates startup fundraising. We index thousands of active VCs, grants, accelerators, and hackathons daily, offering an AI-powered pitch parser to auto-fill applications.</>,
  metricValue = 2400,
  metricLabel = "Active Funds",
  ctaHeading = "Every opportunity.",
  ctaDescription = "Join thousands of founders and students using FundRadar to capture early-stage capital, cloud credits, and hackathon prizes.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-black text-[#f0ede8] font-sans antialiased", className)}
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#listings" onClick={handleScrollTo("listings")} className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-[#c8f135] focus:ring-offset-2">
            <svg className="w-6 h-6 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-800 uppercase mb-[-2px]">Explore Live</div>
              <div className="text-lg font-bold leading-none tracking-tight">Opportunities</div>
            </div>
          </a>
          <a href="#premium" onClick={handleScrollTo("premium")} className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-neutral-700 focus:ring-offset-2 focus:ring-offset-background">
            <svg className="w-6 h-6 text-[#ff6b9d] transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 21l8.982-11.795H14.18l.818-5.09L6 15.904h3.813z" />
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Accelerate with</div>
              <div className="text-lg font-bold leading-none tracking-tight">AI Pitch Autofill</div>
            </div>
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col justify-between">
                      <div className="phone-widget flex justify-between items-center">
                        <div className="flex flex-col">
                          <span className="text-[9px] text-[#ff6b9d] uppercase tracking-widest font-bold mb-0.5">Live Index</span>
                          <span className="text-lg font-black tracking-tight text-white drop-shadow-md">FundRadar</span>
                        </div>
                        <div className="w-8 h-8 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-[11px] border border-white/10 shadow-lg">FR</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[#c8f135]/60 text-[9px] lg:text-[11px] font-medium">Indexed Funding</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[#ff6b9d]/60 text-[9px] lg:text-[11px] font-medium">Scraped opportunities</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="hidden md:block text-[#f0ede8]/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
          </div>
